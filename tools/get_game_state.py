...
if os.path.exists("./logs/game_state.json"):
    os.remove("./logs/game_state.json")
...
class Player():
    ...
    def answer(self, question):
        ...
        #Print_game_state_to_file
        game_state = question["game state"]
        jsonFile = open("logs/game_state.json", "a")
        jsonFile.write(json.dumps(game_state, indent=4, sort_keys=True))
        jsonFile.close()
        # log
        fantom_logger.debug("|\n|")
